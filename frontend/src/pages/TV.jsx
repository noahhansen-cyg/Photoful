...
const styles = {
  page:    { height: "100vh", overflow: "hidden", background: "#0f0f1a", color: "#fff", fontFamily: "sans-serif", display: "flex", flexDirection: "column" },
  header:  { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "0.6rem 2rem", background: "#1a1a2e", borderBottom: "2px solid #2d2d44", flexShrink: 0 },
  roomLabel:   { fontSize: "0.7rem", color: "#aaa" },
  roomCode:    { fontSize: "2rem", fontWeight: "bold", letterSpacing: "0.2em", color: "#6c63ff" },
  headerRight: { display: "flex", alignItems: "center", gap: "0.75rem" },
  joinHint:    { fontSize: "1rem", color: "#aaa" },
  dot: (on) => ({ width: 12, height: 12, borderRadius: "50%", background: on ? "#4ecdc4" : "#ff6b6b" }),
  body:    { flex: 1, display: "flex", minHeight: 0 },
  centered:{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "0.75rem 2rem", gap: "0.85rem", minHeight: 0, overflow: "hidden" },

  promptBadge: { background: "#2d2d44", borderRadius: 999, padding: "0.35rem 1rem", fontSize: "0.9rem", color: "#aaa" },
  bigLabel:    { fontSize: "1.75rem", margin: 0, textAlign: "center" },
  promptText:  { fontSize: "2rem", margin: 0, textAlign: "center", maxWidth: "800px", lineHeight: 1.3 },
  hint:        { color: "#555", fontSize: "0.9rem", margin: 0 },

  playerGrid:  { display: "flex", flexWrap: "wrap", gap: "1rem", justifyContent: "center", maxWidth: "900px" },
  avatarCard:  { display: "flex", flexDirection: "column", alignItems: "center", gap: "0.3rem" },
  avatar:      { width: 52, height: 52, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.3rem", fontWeight: "bold" },
  playerName:  { fontSize: "0.85rem", fontWeight: 600 },
  ...
  photoRow:       { display: "flex", gap: "2rem", flexWrap: "wrap", justifyContent: "center" },
  photoCard:      { display: "flex", flexDirection: "column", alignItems: "center", gap: "0.5rem", maxWidth: "300px" },
  scorePhotoCard: (winner) => ({ display: "flex", flexDirection: "column", alignItems: "center", gap: "0.5rem", maxWidth: "300px", outline: winner ? "4px solid #4ecdc4" : "none", borderRadius: 14, padding: winner ? "0.4rem" : 0 }),
  roundPoints:    { fontSize: "1.5rem", fontWeight: "bold", color: "#4ecdc4", margin: 0 },
  inlineDelta:    { color: "#4ecdc4", fontWeight: "bold" },
  photo:       { width: "100%", maxWidth: "300px", maxHeight: "280px", objectFit: "contain", borderRadius: 12, border: "3px solid #2d2d44" },
  photoPlaceholder: { width: 240, height: 240, background: "#1a1a2e", borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", color: "#555" },
  photoName: (color) => ({ fontSize: "1.1rem", fontWeight: "bold", color: color ?? "#fff" }),
  ...
  leaderboard: { display: "flex", flexDirection: "column", gap: "0.4rem", width: "100%", maxWidth: "500px" },
  leaderRow:   { display: "flex", alignItems: "center", gap: "0.75rem", background: "#1a1a2e", borderRadius: 10, padding: "0.5rem 1rem" },
  rank:        { fontSize: "1rem", color: "#aaa", minWidth: 28 },
  avatarSmall: { width: 30, height: 30, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "0.85rem", fontWeight: "bold" },
  leaderName:  { flex: 1, fontSize: "1rem" },
  delta:       { fontSize: "1rem", color: "#4ecdc4", fontWeight: "bold" },
  score:       { fontSize: "1.2rem", fontWeight: "bold", color: "#6c63ff" },

  promptProgressGrid: { display: "flex", flexDirection: "column", gap: "0.5rem", width: "100%", maxWidth: "600px" },
  promptProgressRow:  { display: "flex", alignItems: "center", gap: "1rem", background: "#1a1a2e", borderRadius: 10, padding: "0.4rem 1rem" },
  ...
  featuredPhoto: { maxWidth: "420px", width: "100%", maxHeight: "240px", objectFit: "contain", borderRadius: 14, border: "3px solid #4ecdc4" },
  ...
  crownEmoji:  { fontSize: "3rem" },
  winnerName:  { fontSize: "1.75rem", color: "#6c63ff", fontWeight: "bold", margin: 0 },
};
